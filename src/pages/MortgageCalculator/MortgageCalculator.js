...
export default class MortgageCalculator extends React.Component {
    ...
    render() {
        ...
        const loanAmountPercent = loanAmount.length === 0 ? '' : (totalPrice > 0 && loanAmount > 0) ? loanAmount / totalPrice : DefaultLoanAmountPercent;
        ...
        return (
            <div className={styles.container}>
                ...
                <form className={styles.inputForm}>
                    <InputWrapper styles={styles} label="Home Value">
                    ...
                    <InputWrapper styles={styles} label="Percent Down">
                    ...
                    <InputWrapper styles={styles} label="Loan Amount">
                        <IconInput styles={styles} icon="$" type="text" name="loanAmount" value={Util.moneyValue(loanAmount, false, false)} onChange={this.onloanAmountChange}/>
                    </InputWrapper>
                    <InputWrapper styles={styles} label="LTV">
                        <IconInput styles={styles} icon="%" type="number" name="loanAmountPercent" value={Util.percentValue(loanAmountPercent, false)} onChange={this.onLoanAmountPercentChange}/>
                    </InputWrapper>
                    </Styled.Grid>
                    ...
                    <InputWrapper styles={styles} label="Additional Principal Payment" subtext={payoffMessage}>
                    ...
                    {showAdvanced ? (
                        <div className={styles.advanced}>
                            ...
                            <InputWrapper styles={styles} label="Homeowners Insurance (HOI)">
                            ...
                            <InputWrapper styles={styles} label="Mortgage Insurance Rate (PMI)">
                            ...
                            <InputWrapper styles={styles} label="Include Mortgage Insurance (PMI)">
                ...
                <div className={styles.versionInfo}>
                    <a href="">mortgage-calculator-react {pjson.version}</a>
                </div>
